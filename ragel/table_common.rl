%%{      
  ...
  table_row = space* BAR >initialize cell+ space* %/store_row %/store_table space* :>> (EOL+ space*); 
  unclosed_table_row = space* BAR >initialize cell* space* ^(BAR|EOL)+ %/bad_table_row %/store_table :>> (EOL+ space*);
