%%{
  ...
  FEATURE = 'Funktionalität:' >start_keyword %end_keyword; 

  # BACKGROUND = 'Background:' >start_keyword %end_keyword;
  BACKGROUND = 'Grundlage:' >start_keyword %end_keyword;

  # SCENARIO = 'Scenario:' >start_keyword %end_keyword;
  SCENARIO = 'Szenario:' >start_keyword %end_keyword;

  # STEP = ('Given ' | 'When ' | 'And ' | 'Then ' | 'But ') >start_keyword %end_keyword;
  STEP = ('Gegeben sei ' | 'Wenn ' | 'Und ' | 'Dann ' | 'Aber ') >start_keyword %end_keyword;
