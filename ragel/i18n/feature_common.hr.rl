%%{
  ...
  FEATURE = 'Osobina|Mogućnost|Mogucnost:' >start_keyword %end_keyword; 

  # BACKGROUND = 'Background:' >start_keyword %end_keyword;
  BACKGROUND = 'Pozadina:' >start_keyword %end_keyword;

  # SCENARIO = 'Scenario:' >start_keyword %end_keyword;
  SCENARIO = 'Scenarij:' >start_keyword %end_keyword;

  # STEP = ('Given ' | 'When ' | 'And ' | 'Then ' | 'But ') >start_keyword %end_keyword;
  STEP = ('Zadan|Zadani|Zadano ' | 'Kada|Kad ' | 'I ' | 'Onda ' | 'Ali ') >start_keyword %end_keyword;
