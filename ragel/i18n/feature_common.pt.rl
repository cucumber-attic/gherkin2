%%{
  ...
  FEATURE = 'Funcionalidade:' >start_keyword %end_keyword; 

  # BACKGROUND = 'Background:' >start_keyword %end_keyword;
  BACKGROUND = 'Contexto:' >start_keyword %end_keyword;

  # SCENARIO = 'Scenario:' >start_keyword %end_keyword;
  SCENARIO = 'Cenário|Cenario:' >start_keyword %end_keyword;

  # STEP = ('Given ' | 'When ' | 'And ' | 'Then ' | 'But ') >start_keyword %end_keyword;
  STEP = ('Dado ' | 'Quando ' | 'E ' | 'Então|Entao ' | 'Mas ') >start_keyword %end_keyword;
