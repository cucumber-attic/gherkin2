...
public class FormatterListener implements Listener {
    ...
    public void feature(String keyword, String name, int line) {
        formatter.feature(grabComments(), grabTags(), keyword, name, uri);
    }

    public void background(String keyword, String name, int line) {
        formatter.background(grabComments(), keyword, name, line);
    }

    public void scenario(String keyword, String name, int line) {
        replayStepsOrExamples();
        formatter.scenario(grabComments(), grabTags(), keyword, name, line);
    }

    public void scenarioOutline(String keyword, String name, int line) {
        replayStepsOrExamples();
        formatter.scenarioOutline(grabComments(), grabTags(), keyword, name, line);
    }

    public void examples(String keyword, String name, int line) {
        replayStepsOrExamples();
        examples = new Examples(grabComments(), grabTags(), keyword, name, line);
    }
    ...
    private class Examples {
        ...
        public Examples(List<String> comments, List<String> tags, String keyword, String name, int line) {
            this.comments = comments;
            this.tags = tags;
            this.keyword = keyword;
            this.name = name;
        ...
        public void replay(Formatter formatter, List<List<String>> examplesTable) {
            formatter.examples(comments, tags, keyword, name, line, examplesTable);
        }
    }
}
