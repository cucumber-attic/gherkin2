...
public class I18nTest {
    ...
    public void shouldFindAllLanguages() throws IOException {
        ...
        assertEquals(asList("af,ar,bg,bm,ca,cs,cy-GB,da,de,el,en,en-Scouse,en-au,en-lol,en-old,en-pirate,en-tx,eo,es,et,fa,fi,fr,gl,he,hi,hr,hu,id,is,it,ja,jv,kn,ko,lt,lu,lv,nl,no,pa,pl,pt,ro,ru,sk,sl,sr-Cyrl,sr-Latn,sv,th,tl,tlh,tr,tt,uk,uz,vi,zh-CN,zh-TW".split(",")), isoCodes);
    }
