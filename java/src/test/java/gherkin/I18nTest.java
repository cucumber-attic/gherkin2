...
public class I18nTest {
    ...
    public void shouldFindAllLanguages() throws IOException {
        ...
        assertEquals(asList("ar,bg,bm,ca,cs,cy-GB,da,de,en,en-Scouse,en-au,en-lol,en-pirate,en-tx,eo,es,et,fa,fi,fr,he,hr,hu,id,is,it,ja,ko,lt,lu,lv,nl,no,pl,pt,ro,ru,sk,sr-Cyrl,sr-Latn,sv,tr,uk,uz,vi,zh-CN,zh-TW".split(",")), isoCodes);
    }
