  ...
  module Parser
    shared_examples_for "a Gherkin parser parsing tables" do
      ...
      it "should parse cells with spaces within the content" do
        ...
        @feature.scan("| Dill pickle | Valencia orange |\n| Ruby red grapefruit | Tire iron |\n")
      end
      ...
      it "should allow utf-8 using should_receive" do
        ...
        @feature.scan("| 繁體中文  而且|並且| 繁體中文  而且|並且|\n")
      end
